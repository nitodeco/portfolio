  ...
  return (
    <div className='flex flex-col md:flex-row justify-between items-center gap-8 md:gap-16 mb-16'>
      ...
      <div className='relative group border-4 border-muted bg-secondary shadow rounded-lg hover:scale-102 hover:rotate-3 transition-transform ease-in-out duration-150'>
        <div className='pointer-events-none absolute -top-6 -right-6 rounded-md bg-secondary px-3 py-1 text-sm font-medium text-secondary-foreground opacity-0 translate-y-1 group-hover:opacity-100 group-hover:translate-y-0 transition duration-150 ease-in-out shadow'>
          {t('hoverText')}
